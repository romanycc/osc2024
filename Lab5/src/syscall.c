...
int sys_fork(Trap_frame *trap_frame) {
  ...
  // uart_puts("===Start fork===\n\n");
  // uart_puts("Trap frame sp ");
  // uart_puth(trap_frame);
  // uart_puts("\n");
  // uart_puts("cur addr ");
  // uart_puth(f);
  // uart_puts("\tcur->sp_el0 ");
  // uart_puth(cur->sp_el0);
  // uart_puts("\ttrap_frame->sp_el0 ");
  // uart_puth(trap_frame->sp_el0);
  // uart_puts("\tcur->regs.sp ");
  // uart_puth(cur->regs.sp);
  // uart_puts("\n");

  // uart_puts("child addr ");
  // uart_puth(c);
  // uart_puts("\tchild->sp_el0 ");
  // uart_puth(child->sp_el0);
  // uart_puts("\tchild->regs.sp ");
  // uart_puth(child->regs.sp);
  // uart_puts("\n\n");


  // Copy kernel stacks...
  // uart_puts("===Copy kernel stacks===\n\n");
  // uart_puti(sizeof(Thread));
  // uart_puts("\n\n");
  ...
  // uart_puts("===Copy callee regs===\n\n");
  // uart_puti(sizeof(callee_regs));
  // uart_puts("\n\n");
  ...
  child->regs.sp = (((char *)trap_frame) - ((char *)cur) + ((char *)child));
  ...
  Trap_frame *trap_frame_child = (Trap_frame *)child->regs.sp;

  // uart_puts("===Setup the return value for child===\n\n");
  // uart_puts("trap_frame_child ");
  // uart_puth(trap_frame_child);
  // uart_puts("\n\n");
  ...
  trap_frame_child->sp_el0 =
      (void *)trap_frame->sp_el0 - (void *)cur->sp_el0 + (void *)child->sp_el0;
  // uart_puts("===Get the displacement of userspace stack===\n\n");
  // uart_puts("trap_frame->sp_el0 ");
  // uart_puth(trap_frame->sp_el0);
  // uart_puts(" trap_frame_child->sp_el0 ");
  // uart_puth(trap_frame_child->sp_el0);
  // uart_puts("\n cur->sp_el0 ");
  // uart_puth( cur->sp_el0);
  // uart_puts("\tchild->sp_el0 ");
  // uart_puth( child->sp_el0);
  ...
  // uart_puts("===Copy user stack===\n");
  // uart_puts("trap_frame->sp_el0\t");
  // uart_puth((char *)trap_frame->sp_el0);
  // uart_puts("\ttrap_frame_child->sp_el0\t");
  // uart_puth((char *)trap_frame_child->sp_el0);
  // uart_puts("\n");
  // uart_puts("cur->sp_el0\t\t");
  // uart_puth((char *)cur->sp_el0);
  // uart_puts("\tchild->sp_el0\t\t\t");
  // uart_puth((char *)child->sp_el0);
  // uart_puts("\n");
  // uart_puth( (char *)cur->sp_el0 - f);
  // uart_puts("\n");
  // uart_puth( f - (char *)cur->sp_el0);
  // uart_puts("\n");
